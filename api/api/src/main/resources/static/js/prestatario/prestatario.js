...
function obtenerDni() {
	...
	return new Promise((resolve, reject) => {
		fetch("/api/prestatario/obtenerDni/" + id)
...
function validarDniExiste() {
	...
	return new Promise((resolve, reject) => {
		fetch("/api/prestatario/validarDniExiste/" + dni)
			.then(response => response.json())
			.then(data => {
				if (data.mensaje) {
...
function validarRucExiste() {
	...
	return new Promise((resolve, reject) => {
		fetch("/api/prestatario/validarRucExiste/" + ruc)
			.then(response => response.json())
			.then(data => {
				if (data.mensaje) {
					toastr.warning(data.mensaje);
...
function validarFormulario() {
	...
	const form = document.getElementById('guardarPrestatario');
