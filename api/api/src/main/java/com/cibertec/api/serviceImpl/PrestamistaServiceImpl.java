...
public class PrestamistaServiceImpl implements PrestamistaService {
	...
	//Listado normal 
	  ...
	  //@Override public List<Prestamista> listarPrestamista()
	  //{ 
		//  return repo.findAll();
	 // }
	...
	public void guardarPrestamista(Prestamista prestamista) {
		// Obtener el objeto Persona del prestamista
		/*
		 * Persona persona = prestamista.getPrestamista();
		 * 
		 ...
		 * 
		 * // Verificar si el objeto Prestamista ya existe en la base de datos if
		...
		//esto con la finalidad para poder actualizar da error de esto
				//detached entity passed to persist: com.cibertec.api.model.Persona
	...
	public void eliminarPrestamista(int id) {
	    ...
	    if (prestamista != null) {
	        ...
	        //al  campo prestamista de tipo Prestamista lo cambia a true osea de eliminado
